...
from syrinx.core.mail.utils import DNS_NAME
from syrinx.utils.encoding import smart_str, force_unicode
...
class EmailMessage(object):
    ...
    def __init__(self, subject='', body='', signature_template=None,
        ...
        self.body = self.get_body(body, signature_template)
    ...
    def get_connection(self, fail_silently=False):
        from syrinx.core.mail import get_connection
...
class EmailMultiAlternatives(EmailMessage):
    ...
    def __init__(self, subject='', body='', from_email=None, to=None, bcc=None,
        ...
        conversions.
        """
        super(EmailMultiAlternatives, self).__init__(subject, body, from_email,
